...
- `P2-M3` 是 P2 收口点：它冻结 principal、visibility 与 memory ledger/read path 边界；完整 Shared Companion、外部协作表面和 self-evolution workflow 均移出 P2。Phase 3 当前设计基线改为 daily-use 能力补完。
...
| v1 | 2026-04-19 | Phase 3 当前设计基线调整为 daily-use 能力补完；self-evolution workflow 从 P3 主线降级 | design_docs/phase3/p3_daily_use_roadmap.md |
